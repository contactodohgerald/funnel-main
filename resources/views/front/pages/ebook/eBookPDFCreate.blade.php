                    ...
                    <div class="row x-pd-r">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input id="author_name" class="form-control no-shadow input-signin" type="text" name="ebook_author" required>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <tbody>
                                    @if (count($selectedArticles) > 0)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                {{ $counter }}
                                                <input type="hidden" name="articleTitle[]" value="{{ $each_articles['title'] }}">
                                                <input type="hidden" name="articleDescription[]" value="{{ $each_articles['description'] }}">
                                            </td>
                                        </tr>
                                            @php $counter++ @endphp   
                                        @endforeach
